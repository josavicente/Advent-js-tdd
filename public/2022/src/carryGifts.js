...
// Nos dan un array con los nombres de los regalos y un número que es el peso máximo que puede llevar
// cada saco. El peso de cada regalo es la longitud de su nombre.
// Escribe una función que agrupe los regalos en sacos y devuelva un array con los nombres de los regalos
//  de cada saco. Para agrupar los regalos, se separan los nombres por espacios (el espacio no cuenta como peso).
// ¡Pero ojo! Cada saco puede llevar un máximo de peso, y si el peso de los regalos de un saco supera el
// peso máximo, se debe separar el último regalo del saco y ponerlo en el siguiente saco.
